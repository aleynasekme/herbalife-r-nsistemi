...
class temel_beslenme_urun extends StatelessWidget {
  @override
        ...
        child: Center(
          child: Column(
            children: [
              ...
              Text(
                "Besleyici Shake Karışımı Formül 1 Çikolata",
                style: TextStyle(
              ...
              Text(
                "Besleyici Shake Karışımı Formül 1 Fındık",
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: Colors.deepOrange,
                  fontSize: 20,
              ...
              Text(
                "Besleyici Shake Karışımı Formül 1 Vanilya",
                style: TextStyle(
                  fontWeight: FontWeight.bold,
                  color: Colors.deepOrange,
                  fontSize: 20,
